...
// ===== LED ===== //
#define LED_DIGITAL
#define LED_PIN_B 2 // ESP-12 / NodeMCU onboard LED (active low)
// Single onboard LED setup: same color channel for scan blink and pre-attack
// solid state.
#define LED_MODE_SCAN 0, 0, 255
#define LED_MODE_IDLE 0, 0, 255
